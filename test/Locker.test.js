...
describe('Locker', function () {
  async function deployFixtures() {
    ...
    const Token = await ethers.deployContract('TestToken', [ORIGINAL_BALANCE, 'Test Token', 'TEST', 18n]); // supply: 200M
  ...
  describe('Utility functions', function () {
    beforeEach(async function () {
      ...
      this.Token2 = await ethers.deployContract('TestToken', [ORIGINAL_BALANCE, 'Test Token', 'TEST', 18n]); // supply: 200M
