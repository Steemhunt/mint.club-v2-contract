...
npx hardhat compile && npx hardhat run --network over scripts/deploy-bulk-sender.js
npx hardhat compile && npx hardhat run --network robinhood scripts/deploy-bulk-sender.js
